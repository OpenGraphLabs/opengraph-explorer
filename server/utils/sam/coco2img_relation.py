...
def extract_parent_child_images(json_path: str, output_dir: str = None, alpha: float = 0.5, line_only: bool = False):
...
def main():
    ...
    if args.extract_relations:
        extract_parent_child_images(args.input, args.output_dir, args.alpha, args.line)
        return
