    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Tabs.Trigger value="community" style={{ fontWeight: 600 }}>
            Community
          </Tabs.Trigger>
        </Tabs.List>
            ...
            <Card style={{ border: "none", boxShadow: "none" }}>
              <Flex direction="column" gap="4">
                ...
                <Text style={{ lineHeight: "1.6" }}>
                  ...
                  This model is stored on the Sui blockchain and can run inference in a fully
                ...
                <Text style={{ lineHeight: "1.6" }}>{getModelArchitecture(model.task)}</Text>
                ...
                >
                  <Text size="2" style={{ fontFamily: "monospace" }}>
                    Object ID: 0x{generateRandomHex(64)}
                  </Text>
                ...
                <Box style={{ background: "#F5F5F5", padding: "16px", borderRadius: "8px" }}>
                  {getModelFiles(model.task).map((file, index) => (
                    <Flex
                      ...
                      style={{
                        borderBottom:
                          index < getModelFiles(model.task).length - 1
