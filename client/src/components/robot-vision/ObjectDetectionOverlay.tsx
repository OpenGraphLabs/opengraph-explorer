    ...
    >
      ...
      {detections.map((detection, index) => {
        ...
        if (!isMobile) {
          ...
          if (scaledX + scaledWidth < -10 || scaledX > containerWidth + 10 ||
              scaledY + scaledHeight < -10 || scaledY > containerHeight + 10) {
            return null;
          }
          ...
          <div key={index}>
            ...
            <div
              style={{
                ...
                boxShadow: isMobile ? '0 0 15px rgba(0, 255, 65, 0.8), inset 0 0 8px rgba(0, 255, 65, 0.2)' : '0 0 8px rgba(0, 255, 65, 0.5)',
