import { Box, Flex, Heading, Text, Card, Grid, Table } from "@radix-ui/themes";
          ...
          >
            ...
            model.graphs[0].layers.length > 0 ? (
              <Flex direction="column" gap="5">
                ...
                >
                  This visualization shows the dimensions and tensor shapes of each layer in the{" "}
                  {model.name} model.
                </Text>
                      ...
                      {model.graphs[0].layers.map((layer, index) => (
                        ...
                        >
                          ...
                          >
                            <Text
                              size="2"
                              style={{ fontWeight: 600, color: "#FF5733", textAlign: "center" }}
                            >
                              Layer {index + 1}
                            </Text>
