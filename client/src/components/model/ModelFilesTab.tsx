import { Box, Flex, Heading, Text, Card, Button, Badge, Separator, Switch } from "@radix-ui/themes";
...
export function ModelFilesTab({ model }: ModelFilesTabProps) {
  ...
  const filteredFiles = showOnlyCodeFiles ? files.filter(file => isCodeFile(file.name)) : files;
        ...
        >
                  ...
                  >
                    ...
                    >
                      <Flex direction="column" gap="3" style={{ height: "100%" }}>
                        ...
                        <Text
                          size="2"
                          style={{ fontWeight: 600, textAlign: "center", marginTop: "4px" }}
                        >
                          {file.name}
                        </Text>
                        <Badge
                        ...
                        >
                          ...
                          <Button variant="ghost" size="1" style={{ color: "#FF5733" }}>
                ...
                {filteredFiles.map((file, index) => (
                  ...
                  >
                    <Flex
                      ...
                      style={{
                        borderBottom:
                          index < filteredFiles.length - 1 ? "1px solid var(--gray-a2)" : "none",
                        padding: "14px 10px",
                        borderRadius: "4px",
                    ...
                    >
                      <Flex gap="3" align="center">
                        ...
                        <Badge size="1" variant="soft" color={getFileBadgeColor(file.name)}>
                          {file.name.split(".").pop()?.toUpperCase()}
                        </Badge>
                      </Flex>
          ...
          >
            ...
            >
              ...
              <Text style={{ display: "block", marginLeft: "20px" }}>id: modelId,</Text>
