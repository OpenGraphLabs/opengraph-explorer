...
export function ModelInferenceTab({ model }: ModelInferenceTabProps) {
  ...
  }, [isCanvasActive, drawingColor, lineThickness, brushStyle]);

  // Update line thickness and color when changed
  useEffect(() => {
    if (canvasContext) {
  ...
  // Process canvas image to vectors
  ...
  // Process uploaded image to vector
  ...
  }, [getFirstLayerDimension, setInputVector, setInputValues, setInputSigns]);
  ...
  const stopDrawing = useCallback(() => {
    if (isDrawing && canvasContext) {
      ...
      // Process the image on mouse up, but still allow continued drawing
      processCanvasImage();
    }
                    ...
                    <Flex direction="column" gap="4">
                      <Flex justify="between" align="center">
                        ...
                        <Flex gap="2">
                          ...
                          >
                            <PencilSimple size={16} weight="bold" /> Draw Image
                          </Button>
                        </Flex>
                      </Flex>
