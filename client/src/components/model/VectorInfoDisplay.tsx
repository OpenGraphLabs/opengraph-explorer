...
import { CheckCircle, Graph, Table, ChartLine, Code as CodeIcon, ArrowsHorizontal } from "phosphor-react";
                ...
                <Box>
                  ...
                  <Card style={{ background: '#F9F9F9', marginBottom: '16px' }}>
                    <Flex direction="column" gap="2">
                      <Flex align="center" gap="2">
                        ...
                        <Text size="2" style={{ fontWeight: 500 }}>Vector Visualization</Text>
                      </Flex>
                  ...
                  <Flex gap="2" direction="column">
                    <Flex align="center" gap="2" mb="1">
                      ...
                      <Text size="2" style={{ fontWeight: 500 }}>Vector Statistics</Text>
                    </Flex>
                        ...
                        <Flex direction="column" gap="1">
                          ...
                          <Text size="3" style={{ fontWeight: 500, color: '#FF5733' }}>
                            {imageData.vector ? 
                              ...
                              (imageData.vector.length || 1)).toFixed(3) : 
                              "0.000"}
                          </Text>
                        </Flex>
                      </Card>
