...
export function InteractiveAnnotationCanvas({
  ...
  const zoomToPoint = useCallback(
    (pointX: number, pointY: number, delta: number) => {
  ...
  const checkBboxIntersection = useCallback(
    (bbox: BoundingBox, annotation: Annotation): boolean => {
  ...
  const updateMaskSelection = useCallback(
    (bbox: BoundingBox) => {
