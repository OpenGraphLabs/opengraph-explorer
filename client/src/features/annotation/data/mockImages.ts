...
export const mockImages: ImageData[] = [
  ...
  },
  {
    ...
    annotations: {
      labels: [
        { id: 'label1', label: 'urban_scene', confidence: 0.95 }
      ],
      boundingBoxes: [
  ...
  },
  {
    ...
    annotations: {
      labels: [],
      boundingBoxes: [
        { id: 'bbox3', x: 200, y: 100, width: 400, height: 300, label: 'building', confidence: 0.96 }
      ],
      polygons: [
        {
          id: 'polygon1',
  ...
  },
  {
    ...
    annotations: {
      labels: [
        { id: 'label2', label: 'landscape', confidence: 0.98 }
      ],
      boundingBoxes: [],
      polygons: []
    }
