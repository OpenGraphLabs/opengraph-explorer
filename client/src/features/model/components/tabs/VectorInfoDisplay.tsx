  ...
  const VectorVisualization = () => {
    ...
    return (
      <Box style={{ position: "relative", marginTop: "16px" }}>
        ...
        <Text size="1" style={{ textAlign: "center", marginTop: "8px", color: theme.colors.text.secondary }}>
              ...
              <Flex align="center" justify="center" gap="3" style={{ margin: "20px 0" }}>
                ...
                >
                  ...
                  >
                    ...
                    <Text size="1" style={{ color: theme.colors.text.secondary, fontFamily: "monospace", zIndex: 2 }}>
            ...
            <>
              ...
              <Flex gap="2" mb="3">
                <Button
                  ...
                  style={{ 
                    cursor: "pointer",
                    background: activeTab === "visual" ? theme.colors.interactive.primary : "transparent",
                    color: activeTab === "visual" ? theme.colors.text.inverse : theme.colors.text.secondary
                  }}
                >
                ...
                <Button
                  ...
                  style={{ 
                    cursor: "pointer",
                    background: activeTab === "data" ? theme.colors.interactive.primary : "transparent",
                    color: activeTab === "data" ? theme.colors.text.inverse : theme.colors.text.secondary
                  }}
                >
              ...
              {activeTab === "visual" ? (
                  ...
                  <Box>
                    {/* 벡터 시각화 */}
                    <Card style={{ background: theme.colors.background.secondary, marginBottom: "16px" }}>
                      <Flex direction="column" gap="2">
                        <Flex align="center" gap="2">
                          <Table size={16} weight="fill" style={{ color: theme.colors.interactive.primary }} />
                  ...
                  {/* 통계 정보 */}
                      ...
                      <Flex align="center" gap="2" mb="1">
                        <ChartLine size={16} weight="fill" style={{ color: theme.colors.interactive.primary }} />
                        <Text size="2" style={{ fontWeight: 500, color: theme.colors.text.primary }}>
                          Vector Statistics
                        </Text>
                      </Flex>
                    ...
                    <Grid columns="4" gap="2" width="auto">
                        ...
                        <CheckCircle size={14} weight="fill" style={{ color: theme.colors.status.success }} />
                        <Text size="1" style={{ color: theme.colors.text.secondary }}>
                    ...
                    <Box>
                      <Flex direction="column" gap="3">
                        ...
                        <Card style={{ background: theme.colors.background.secondary }}>
                          <Flex direction="column" gap="2">
                            <Flex align="center" gap="2">
                              <ArrowsHorizontal size={16} weight="fill" style={{ color: theme.colors.interactive.primary }} />
                              <Text size="2" style={{ fontWeight: 500, color: theme.colors.text.primary }}>
                    ...
                    {/* 자세한 벡터 데이터 */}
                      ...
                      <Grid columns="2" gap="2">
                        <Card>
                          <Text size="1" style={{ color: theme.colors.text.primary, marginBottom: "4px", fontWeight: 500 }}>
                            Magnitudes
                          </Text>
                          <Code
                            style={{
