...
export const AnnotationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost: async (requestBody: Array<object>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'requestBody' is not null or undefined
            assertParamExists('approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost', 'requestBody', requestBody)
         ...
         * @throws {RequiredError}
         */
        getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet: async (minSelectionCount?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AnnotationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost(requestBody: Array<object>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost(requestBody, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AnnotationsApi.approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnnotationSelectionSummary>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AnnotationsApi.getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get annotation selections ready for approval  Returns items that have the same selection made by at least the specified minimum number of users.
         ...
         * @throws {RequiredError}
         */
        async getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet(minSelectionCount?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AnnotationSelectionStats>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet(minSelectionCount, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AnnotationsApi.getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update a annotation selection  Mainly used for category update or status change by administrator
...
export const AnnotationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost(requestParameters: AnnotationsApiApproveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<any> {
            return localVarFp.approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost(requestParameters.requestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new annotation selection  Records user selections that combine multiple AUTO annotations to form a meaningful entity. If the same selection is made by five or more users, it is automatically marked as APPROVED.
         * @summary Create Annotation Selection
         ...
         * @throws {RequiredError}
         */
        getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet(options?: RawAxiosRequestConfig): AxiosPromise<AnnotationSelectionSummary> {
            return localVarFp.getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet(options).then((request) => request(axios, basePath));
        },
        /**
         * Get annotation selections ready for approval  Returns items that have the same selection made by at least the specified minimum number of users.
         * @summary Get Selections Ready For Approval
         ...
         * @throws {RequiredError}
         */
        getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet(requestParameters: AnnotationsApiGetSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGetRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<AnnotationSelectionStats>> {
            return localVarFp.getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet(requestParameters.minSelectionCount, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a annotation selection  Mainly used for category update or status change by administrator
         * @summary Update Annotation Selection
...
export class AnnotationsApi extends BaseAPI implements AnnotationsApiInterface {
     ...
     */
    public approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost(requestParameters: AnnotationsApiApproveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPostRequest, options?: RawAxiosRequestConfig) {
        return AnnotationsApiFp(this.configuration).approveSelectionsBatchApiV1AnnotationsSelectionsApproveBatchPost(requestParameters.requestBody, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet(options?: RawAxiosRequestConfig) {
        return AnnotationsApiFp(this.configuration).getSelectionSummaryApiV1AnnotationsSelectionsSummaryGet(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AnnotationsApi
     */
    public getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet(requestParameters: AnnotationsApiGetSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGetRequest = {}, options?: RawAxiosRequestConfig) {
        return AnnotationsApiFp(this.configuration).getSelectionsReadyForApprovalApiV1AnnotationsSelectionsReadyForApprovalGet(requestParameters.minSelectionCount, options).then((request) => request(this.axios, this.basePath));
    }
