...
export const DictionaryCategoriesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost: async (
     ...
     * @throws {RequiredError}
     */
    createDictionaryCategoryApiV1DictionaryCategoriesPost: async (
     ...
     * @throws {RequiredError}
     */
    deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete: async (
      dictionaryId: number,
      categoryId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGet: async (
      dictionaryId: number,
      page?: number,
      limit?: number,
      options: RawAxiosRequestConfig = {}
      ...
      const localVarPath = `/api/v1/dictionary-categories/{dictionary_id}`.replace(
        `{${"dictionary_id"}}`,
        encodeURIComponent(String(dictionaryId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const DictionaryCategoriesApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost(
      dictionaryCategoryBatchCreate: DictionaryCategoryBatchCreate,
      options?: RawAxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DictionaryCategoryRead>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost(
          dictionaryCategoryBatchCreate,
          options
        );
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          "DictionaryCategoriesApi.createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost"
     ...
     * @throws {RequiredError}
     */
    async createDictionaryCategoryApiV1DictionaryCategoriesPost(
      dictionaryCategoryCreate: DictionaryCategoryCreate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DictionaryCategoryRead>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createDictionaryCategoryApiV1DictionaryCategoriesPost(
          dictionaryCategoryCreate,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap[
          "DictionaryCategoriesApi.createDictionaryCategoryApiV1DictionaryCategoriesPost"
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete(
      dictionaryId: number,
      categoryId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete(
          dictionaryId,
          categoryId,
          options
        );
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          "DictionaryCategoriesApi.deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete"
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async getDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGet(
      dictionaryId: number,
      page?: number,
      limit?: number,
      options?: RawAxiosRequestConfig
      ...
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGet(
          dictionaryId,
          page,
          limit,
          options
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          "DictionaryCategoriesApi.getDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGet"
        ]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const DictionaryCategoriesApiFactory = function (
  ...
  return {
     ...
     */
    createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost(
      requestParameters: DictionaryCategoriesApiCreateDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPostRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<DictionaryCategoryRead>> {
      return localVarFp
        .createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost(
          requestParameters.dictionaryCategoryBatchCreate,
          options
        )
     ...
     */
    createDictionaryCategoryApiV1DictionaryCategoriesPost(
      requestParameters: DictionaryCategoriesApiCreateDictionaryCategoryApiV1DictionaryCategoriesPostRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DictionaryCategoryRead> {
      return localVarFp
        .createDictionaryCategoryApiV1DictionaryCategoriesPost(
          requestParameters.dictionaryCategoryCreate,
          options
        )
        .then(request => request(axios, basePath));
    },
     ...
     */
    deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete(
      requestParameters: DictionaryCategoriesApiDeleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDeleteRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<any> {
      return localVarFp
        .deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete(
          requestParameters.dictionaryId,
     ...
     */
    getDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGet(
      requestParameters: DictionaryCategoriesApiGetDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGetRequest,
      options?: RawAxiosRequestConfig
...
export class DictionaryCategoriesApi extends BaseAPI implements DictionaryCategoriesApiInterface {
   ...
   */
  public createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost(
    requestParameters: DictionaryCategoriesApiCreateDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPostRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DictionaryCategoriesApiFp(this.configuration)
      .createDictionaryCategoriesBatchApiV1DictionaryCategoriesBatchPost(
        requestParameters.dictionaryCategoryBatchCreate,
        options
      )
   ...
   * @memberof DictionaryCategoriesApi
   */
  public createDictionaryCategoryApiV1DictionaryCategoriesPost(
    requestParameters: DictionaryCategoriesApiCreateDictionaryCategoryApiV1DictionaryCategoriesPostRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DictionaryCategoriesApiFp(this.configuration)
   ...
   * @memberof DictionaryCategoriesApi
   */
  public deleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDelete(
    requestParameters: DictionaryCategoriesApiDeleteDictionaryCategoryApiV1DictionaryCategoriesDictionaryIdCategoryIdDeleteRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DictionaryCategoriesApiFp(this.configuration)
   ...
   * @memberof DictionaryCategoriesApi
   */
  public getDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGet(
    requestParameters: DictionaryCategoriesApiGetDictionaryCategoriesApiV1DictionaryCategoriesDictionaryIdGetRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DictionaryCategoriesApiFp(this.configuration)
