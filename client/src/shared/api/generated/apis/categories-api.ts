...
export const CategoriesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    createCategoryApiV1CategoriesPost: async (
     ...
     * @throws {RequiredError}
     */
    deleteCategoryApiV1CategoriesCategoryIdDelete: async (
      categoryId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getCategoriesApiV1CategoriesGet: async (
      page?: number,
      limit?: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getCategoryApiV1CategoriesCategoryIdGet: async (
      categoryId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'categoryId' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    updateCategoryApiV1CategoriesCategoryIdPut: async (
      categoryId: number,
...
export const CategoriesApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createCategoryApiV1CategoriesPost(
      categoryCreate: CategoryCreate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CategoryRead>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createCategoryApiV1CategoriesPost(
        categoryCreate,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CategoriesApi.createCategoryApiV1CategoriesPost"]?.[
     ...
     * @throws {RequiredError}
     */
    async deleteCategoryApiV1CategoriesCategoryIdDelete(
      categoryId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteCategoryApiV1CategoriesCategoryIdDelete(
          categoryId,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CategoriesApi.deleteCategoryApiV1CategoriesCategoryIdDelete"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getCategoriesApiV1CategoriesGet(
      page?: number,
      limit?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CategoryListResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCategoriesApiV1CategoriesGet(
        page,
        limit,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CategoriesApi.getCategoriesApiV1CategoriesGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getCategoryApiV1CategoriesCategoryIdGet(
      categoryId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CategoryRead>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCategoryApiV1CategoriesCategoryIdGet(
          categoryId,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CategoriesApi.getCategoryApiV1CategoriesCategoryIdGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async updateCategoryApiV1CategoriesCategoryIdPut(
      categoryId: number,
      categoryUpdate: CategoryUpdate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CategoryRead>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateCategoryApiV1CategoriesCategoryIdPut(
          categoryId,
          categoryUpdate,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CategoriesApi.updateCategoryApiV1CategoriesCategoryIdPut"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const CategoriesApiFactory = function (
  ...
  return {
    ...
    createCategoryApiV1CategoriesPost(
      requestParameters: CategoriesApiCreateCategoryApiV1CategoriesPostRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CategoryRead> {
      return localVarFp
        .createCategoryApiV1CategoriesPost(requestParameters.categoryCreate, options)
    ...
    deleteCategoryApiV1CategoriesCategoryIdDelete(
      requestParameters: CategoriesApiDeleteCategoryApiV1CategoriesCategoryIdDeleteRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<any> {
      return localVarFp
        .deleteCategoryApiV1CategoriesCategoryIdDelete(requestParameters.categoryId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * List all categories.
     * @summary Get Categories
     * @param {CategoriesApiGetCategoriesApiV1CategoriesGetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getCategoriesApiV1CategoriesGet(
      requestParameters: CategoriesApiGetCategoriesApiV1CategoriesGetRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CategoryListResponse> {
      return localVarFp
        .getCategoriesApiV1CategoriesGet(requestParameters.page, requestParameters.limit, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Get a specific category.
    ...
    getCategoryApiV1CategoriesCategoryIdGet(
      requestParameters: CategoriesApiGetCategoryApiV1CategoriesCategoryIdGetRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CategoryRead> {
      return localVarFp
        .getCategoryApiV1CategoriesCategoryIdGet(requestParameters.categoryId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Update a specific category.
     ...
     */
    updateCategoryApiV1CategoriesCategoryIdPut(
      requestParameters: CategoriesApiUpdateCategoryApiV1CategoriesCategoryIdPutRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CategoryRead> {
      return localVarFp
        .updateCategoryApiV1CategoriesCategoryIdPut(
          requestParameters.categoryId,
          requestParameters.categoryUpdate,
          options
        )
        .then(request => request(axios, basePath));
    },
...
/**
 * Request parameters for getCategoriesApiV1CategoriesGet operation in CategoriesApi.
 * @export
 * @interface CategoriesApiGetCategoriesApiV1CategoriesGetRequest
 */
export interface CategoriesApiGetCategoriesApiV1CategoriesGetRequest {
  /**
   *
   * @type {number}
   * @memberof CategoriesApiGetCategoriesApiV1CategoriesGet
   */
...
export class CategoriesApi extends BaseAPI implements CategoriesApiInterface {
   ...
   * @memberof CategoriesApi
   */
  public deleteCategoryApiV1CategoriesCategoryIdDelete(
    requestParameters: CategoriesApiDeleteCategoryApiV1CategoriesCategoryIdDeleteRequest,
    options?: RawAxiosRequestConfig
  ) {
    return CategoriesApiFp(this.configuration)
   ...
   * @memberof CategoriesApi
   */
  public updateCategoryApiV1CategoriesCategoryIdPut(
    requestParameters: CategoriesApiUpdateCategoryApiV1CategoriesCategoryIdPutRequest,
    options?: RawAxiosRequestConfig
  ) {
    return CategoriesApiFp(this.configuration)
