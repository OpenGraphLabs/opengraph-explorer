...
export const DatasetsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    createDatasetApiV1DatasetsPost: async (
     ...
     * @throws {RequiredError}
     */
    deleteDatasetApiV1DatasetsDatasetIdDelete: async (
      datasetId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'datasetId' is not null or undefined
      assertParamExists("deleteDatasetApiV1DatasetsDatasetIdDelete", "datasetId", datasetId);
      const localVarPath = `/api/v1/datasets/{dataset_id}`.replace(
        `{${"dataset_id"}}`,
     ...
     * @throws {RequiredError}
     */
    getDatasetApiV1DatasetsDatasetIdGet: async (
      datasetId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'datasetId' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    getDatasetImagesApiV1DatasetsDatasetIdImagesGet: async (
      datasetId: number,
      page?: number,
      limit?: number,
      options: RawAxiosRequestConfig = {}
      ...
      const localVarPath = `/api/v1/datasets/{dataset_id}/images`.replace(
        `{${"dataset_id"}}`,
        encodeURIComponent(String(datasetId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getDatasetsApiV1DatasetsGet: async (
      page?: number,
      limit?: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    updateDatasetApiV1DatasetsDatasetIdPut: async (
      datasetId: number,
...
export const DatasetsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createDatasetApiV1DatasetsPost(
      datasetCreate: DatasetCreate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatasetRead>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createDatasetApiV1DatasetsPost(
        datasetCreate,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetsApi.createDatasetApiV1DatasetsPost"]?.[
     ...
     * @throws {RequiredError}
     */
    async deleteDatasetApiV1DatasetsDatasetIdDelete(
      datasetId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteDatasetApiV1DatasetsDatasetIdDelete(
          datasetId,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetsApi.deleteDatasetApiV1DatasetsDatasetIdDelete"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getDatasetApiV1DatasetsDatasetIdGet(
      datasetId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatasetRead>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDatasetApiV1DatasetsDatasetIdGet(
        datasetId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetsApi.getDatasetApiV1DatasetsDatasetIdGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getDatasetImagesApiV1DatasetsDatasetIdImagesGet(
      datasetId: number,
      page?: number,
      limit?: number,
      options?: RawAxiosRequestConfig
      ...
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDatasetImagesApiV1DatasetsDatasetIdImagesGet(
          datasetId,
          page,
          limit,
          options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetsApi.getDatasetImagesApiV1DatasetsDatasetIdImagesGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getDatasetsApiV1DatasetsGet(
      page?: number,
      limit?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatasetListResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDatasetsApiV1DatasetsGet(
        page,
        limit,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetsApi.getDatasetsApiV1DatasetsGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async updateDatasetApiV1DatasetsDatasetIdPut(
      datasetId: number,
      datasetUpdate: DatasetUpdate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatasetRead>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateDatasetApiV1DatasetsDatasetIdPut(
          datasetId,
          datasetUpdate,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DatasetsApi.updateDatasetApiV1DatasetsDatasetIdPut"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const DatasetsApiFactory = function (
  ...
  return {
    ...
    createDatasetApiV1DatasetsPost(
      requestParameters: DatasetsApiCreateDatasetApiV1DatasetsPostRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DatasetRead> {
      return localVarFp
        .createDatasetApiV1DatasetsPost(requestParameters.datasetCreate, options)
    ...
    deleteDatasetApiV1DatasetsDatasetIdDelete(
      requestParameters: DatasetsApiDeleteDatasetApiV1DatasetsDatasetIdDeleteRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<void> {
      return localVarFp
        .deleteDatasetApiV1DatasetsDatasetIdDelete(requestParameters.datasetId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Get a dataset by id.
    ...
    getDatasetApiV1DatasetsDatasetIdGet(
      requestParameters: DatasetsApiGetDatasetApiV1DatasetsDatasetIdGetRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DatasetRead> {
      return localVarFp
        .getDatasetApiV1DatasetsDatasetIdGet(requestParameters.datasetId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Get all images in a dataset.
    ...
    getDatasetImagesApiV1DatasetsDatasetIdImagesGet(
      requestParameters: DatasetsApiGetDatasetImagesApiV1DatasetsDatasetIdImagesGetRequest,
      options?: RawAxiosRequestConfig
    ...
    getDatasetsApiV1DatasetsGet(
      requestParameters: DatasetsApiGetDatasetsApiV1DatasetsGetRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DatasetListResponse> {
      return localVarFp
        .getDatasetsApiV1DatasetsGet(requestParameters.page, requestParameters.limit, options)
        .then(request => request(axios, basePath));
    },
    /**
     * 데이터셋을 업데이트합니다.
    ...
    updateDatasetApiV1DatasetsDatasetIdPut(
      requestParameters: DatasetsApiUpdateDatasetApiV1DatasetsDatasetIdPutRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DatasetRead> {
      return localVarFp
        .updateDatasetApiV1DatasetsDatasetIdPut(
          requestParameters.datasetId,
          requestParameters.datasetUpdate,
          options
        )
        .then(request => request(axios, basePath));
    },
...
export class DatasetsApi extends BaseAPI implements DatasetsApiInterface {
   ...
   */
  public createDatasetApiV1DatasetsPost(
    requestParameters: DatasetsApiCreateDatasetApiV1DatasetsPostRequest,
    options?: RawAxiosRequestConfig
  ) {
   ...
   * @memberof DatasetsApi
   */
  public getDatasetImagesApiV1DatasetsDatasetIdImagesGet(
    requestParameters: DatasetsApiGetDatasetImagesApiV1DatasetsDatasetIdImagesGetRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DatasetsApiFp(this.configuration)
   ...
   * @memberof DatasetsApi
   */
  public getDatasetsApiV1DatasetsGet(
    requestParameters: DatasetsApiGetDatasetsApiV1DatasetsGetRequest = {},
    options?: RawAxiosRequestConfig
  ) {
    return DatasetsApiFp(this.configuration)
   ...
   * @memberof DatasetsApi
   */
  public updateDatasetApiV1DatasetsDatasetIdPut(
    requestParameters: DatasetsApiUpdateDatasetApiV1DatasetsDatasetIdPutRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DatasetsApiFp(this.configuration)
