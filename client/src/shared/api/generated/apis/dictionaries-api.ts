...
export const DictionariesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    createDictionaryApiV1DictionariesPost: async (
     ...
     * @throws {RequiredError}
     */
    getDictionaryApiV1DictionariesDictionaryIdGet: async (
      dictionaryId: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v1/dictionaries/{dictionary_id}`.replace(
        `{${"dictionary_id"}}`,
...
export const DictionariesApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createDictionaryApiV1DictionariesPost(
      dictionaryCreate: DictionaryCreate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DictionaryRead>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createDictionaryApiV1DictionariesPost(
          dictionaryCreate,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DictionariesApi.createDictionaryApiV1DictionariesPost"]?.[
     ...
     * @throws {RequiredError}
     */
    async getDictionaryApiV1DictionariesDictionaryIdGet(
      dictionaryId: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DictionaryRead>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDictionaryApiV1DictionariesDictionaryIdGet(
          dictionaryId,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DictionariesApi.getDictionaryApiV1DictionariesDictionaryIdGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const DictionariesApiFactory = function (
  ...
  return {
     ...
     */
    createDictionaryApiV1DictionariesPost(
      requestParameters: DictionariesApiCreateDictionaryApiV1DictionariesPostRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DictionaryRead> {
      return localVarFp
        .createDictionaryApiV1DictionariesPost(requestParameters.dictionaryCreate, options)
     ...
     */
    getDictionaryApiV1DictionariesDictionaryIdGet(
      requestParameters: DictionariesApiGetDictionaryApiV1DictionariesDictionaryIdGetRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<DictionaryRead> {
      return localVarFp
        .getDictionaryApiV1DictionariesDictionaryIdGet(requestParameters.dictionaryId, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export class DictionariesApi extends BaseAPI implements DictionariesApiInterface {
   ...
   */
  public createDictionaryApiV1DictionariesPost(
    requestParameters: DictionariesApiCreateDictionaryApiV1DictionariesPostRequest,
    options?: RawAxiosRequestConfig
  ) {
   ...
   * @memberof DictionariesApi
   */
  public getDictionaryApiV1DictionariesDictionaryIdGet(
    requestParameters: DictionariesApiGetDictionaryApiV1DictionariesDictionaryIdGetRequest,
    options?: RawAxiosRequestConfig
  ) {
    return DictionariesApiFp(this.configuration)
