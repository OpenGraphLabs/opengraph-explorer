...
export const ImagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        addImageApiV1ImagesPost: async (imageCreate: ImageCreate, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(imageCreate, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getImageApiV1ImagesImageIdGet: async (imageId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'imageId' is not null or undefined
            assertParamExists('getImageApiV1ImagesImageIdGet', 'imageId', imageId)
            const localVarPath = `/api/v1/images/{image_id}`
...
export const ImagesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addImageApiV1ImagesPost(imageCreate: ImageCreate, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImageRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addImageApiV1ImagesPost(imageCreate, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ImagesApi.addImageApiV1ImagesPost']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getImageApiV1ImagesImageIdGet(imageId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImageRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getImageApiV1ImagesImageIdGet(imageId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ImagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addImageApiV1ImagesPost(requestParameters: ImagesApiAddImageApiV1ImagesPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<ImageRead> {
            return localVarFp.addImageApiV1ImagesPost(requestParameters.imageCreate, options).then((request) => request(axios, basePath));
        },
        /**
         * Get specific image by ID.
         * @summary Get Image
...
export class ImagesApi extends BaseAPI implements ImagesApiInterface {
     ...
     * @memberof ImagesApi
     */
    public addImageApiV1ImagesPost(requestParameters: ImagesApiAddImageApiV1ImagesPostRequest, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).addImageApiV1ImagesPost(requestParameters.imageCreate, options).then((request) => request(this.axios, this.basePath));
    }
