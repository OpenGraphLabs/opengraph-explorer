  ...
  return {
    ...
    async healthCheckHealthGet(
      ...
      const localVarOperationServerBasePath =
        operationServerMap["DefaultApi.healthCheckHealthGet"]?.[localVarOperationServerIndex]?.url;
    ...
    async rootGet(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DefaultApi.rootGet"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
